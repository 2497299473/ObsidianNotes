...
created: 2026-06-25
description: 深入解析 Claude Code 的工具系统内核：设计哲学与分类、风险等级、五个原子操作到涌现能力、权限控制体系、工具扩展与架构定位。
tags:
  - clippings
  - claude-code
  - tools
lark_doc_url: https://my.feishu.cn/docx/WewNd7gz7oVwX7xwGA0cQC7ZnWf
---
...
![](https://static001.geekbang.org/resource/image/e8/1d/e89407a8ddef056f5bc509b6503cd81d.jpg?wh=2213x1041)

![](https://static001.geekbang.org/resource/image/e6/a4/e63bf24c69fd64ea55507e3d8f6773a4.jpg?wh=2735x883)
...
早期，Claude Code 只是内置了十几个工具（目前逐渐增多，可能已经有 20 多个了，最新列表在 [这里](https://docs.anthropic.com/en/docs/claude-code/tools)），按功能分为六个类别。
...
内置工具覆盖了大部分编码任务，但连接外部系统时需要扩展。工具能力可以分为三个层次——从内置原语到 Bash 可达再到 MCP 扩展，每一层都在前一层的基础上拓展能力边界。
...
![](https://static001.geekbang.org/resource/image/a9/ed/a951a6a7e21da2ede02d3cbfa91977ed.jpg?wh=2848x1955)

![](https://static001.geekbang.org/resource/image/b9/a9/b96f4124fa221d40aa518a0e4fe770a9.jpg?wh=2894x1130)
