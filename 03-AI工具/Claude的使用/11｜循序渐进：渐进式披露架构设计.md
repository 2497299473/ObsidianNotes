...
tags:
  ...
  - Skills
  - 渐进式披露
description: 通过三层分层结构（目录/章节/附录）按需加载，提高 token 利用率，解决信息噪声和 token 爆炸问题，平均节省 50-80% tokens。
lark_doc_url: https://my.feishu.cn/docx/WyyJd6YlYogQ40xn9fwcMgo5nDd
---
