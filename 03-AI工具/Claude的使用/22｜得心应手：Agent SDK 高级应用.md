---
title: 22｜得心应手：Agent SDK 高级应用
source: https://time.geekbang.org/column/article/966254
author: 黄佳
published: 2026-04-14
created: 2026-06-28
description: Agent SDK 高级应用：自定义工具、Hooks 拦截、权限分层、流式会话，及生产环境最佳实践。
tags:
  - clippings
  - claude-code
  - agent-sdk
status: 📝 待处理
lark_doc_url: https://my.feishu.cn/docx/FyAXduVUeoM9USxV8e6cGRx8nwe
---
...
print (f"\nCompleted in {msg.duration_ms/ 1000:.1 f} s")

print (f" Cost: $ {msg.total_cost_usd:.4 f} ")
