...
description: “子代理（Sub-Agents）是 Claude Code 的核心能力——通过上下文隔离让专业 Agent 做专业的事，只将结论带回主对话。本讲深入子代理的核心概念、工程价值与配置详解。”
tags:
  - clippings
  - claude-code
  - sub-agents
  - 极客时间
lark_doc_url: https://my.feishu.cn/docx/USWydLRoTo0aypx4xt7c4QIInXb
---
