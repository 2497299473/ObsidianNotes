...
description: “Claude Code 记忆系统是一种五层级的记忆架构，用于解决与 AI 合作时的「失忆症」问题。通过精简、具体、渐进式披露和关键三问题原则，CLAUDE.md 编写能大幅提高工作效率。”
tags:
  - clippings
  - claude-code
  - 极客时间
related: "[[CLAUDE.md 的期望值决策框架]]"
lark_doc_url: https://my.feishu.cn/docx/ZJb1dDJKboTrXFxgBDqcLr7pnJh
---
