---
title: 01｜用户视角：你应该知道的LLM基础知识
date: 2026-09-23
source: https://time.geekbang.org/column/article/821473
tags:
  - clippings
  - LLM
  - GPT
...
> [!ABSTRACT] 快速概览
> 从用户视角理解大模型：ChatGPT 因聊天形态破圈；LLM = 模型 + 语言模型 + “大”。以 GPT 为例总结四个“知”——知识丰富、知人晓事、知错就改、知法守法，帮助你成为大模型高级用户，并为后续 AI 应用开发打底。

---

## 📝 正文内容

<audio title="01｜用户视角：你应该知道的LLM基础知识" src="https://res001.geekbang.org/media/tts_audio/20250928/tts-3244-4-820975/ld/ld.m3u8"></audio>
...
那么你是否想过这样一个问题，为什么 ChatGPT 能成为增长最快的应用？
...
- [ ] 对照四个“知”，写下自己日常用大模型时最依赖哪一条
- [ ] 用“知人晓事”特点，为自己常用场景设计一个角色设定
- [ ] 记录一次“知错就改”实操：指出错误后观察回答如何变化
...
- 极客时间《程序员的 AI 开发第一课》第 01 讲 — 郑晔
- LLM（Large Language Model）基础概念
...
> [!TIP]
> 理解 LLM，先从用户视角出发——把大模型当成“知识丰富、知人晓事、知错就改、知法守法”的高级助手来用。
