---
title: 开篇词｜普通程序员如何迈进AI时代？
date: 2026-09-23
source: https://time.geekbang.org/column/article/821470
tags:
  - clippings
  - AI应用开发
  - LLM
...
> [!ABSTRACT] 快速概览
> 面向普通程序员的 AI 应用开发导览：说明 AI 时代程序员的价值，对比传统硬编码与“部分规则由模型判定”的新开发模式，并预告课程三大板块——大模型基础、应用开发（OpenAI API / LangChain / RAG / Agent / 工程实践）与模型能力（开源模型、微调）。

---

## 📝 正文内容

<audio title="开篇词 | 普通程序员如何迈进AI时代？" src="https://res001.geekbang.org/media/tts_audio/20250928/tts-3243-4-820934/ld/ld.m3u8"></audio>
...
我在 《10x 程序员工作法》 中讲了做软件开发的一些原则。

在 《软件设计之美》 分享了如何学习软件设计。
...
当我写下这些文字时，AI 世界依然在剧烈变化着，我实在不敢说这些内容是否会有陈旧过期的情况，所以，我也只能抱着一颗交流的心去开启这门新课。如果你在学习的过程中，发现一些地方你会有更值得推荐的做法，请不吝赐教。

来吧，我们一起奔向 AI 时代，让我们成为 AI 时代的构建者！

## ✅ 待办事项

- [ ] 通读课程地图，标出与当前工作最相关的模块（基础 / 应用 / 模型）
- [ ] 列出一个可在本职项目中落地的 AI 功能想法
- [ ] 确认开发环境：可调用的大模型 API 与账号
...
- 极客时间《程序员的 AI 开发第一课》开篇词 — 郑晔
- [《10x 程序员工作法》](https://time.geekbang.org/column/100006301)
- [《软件设计之美》](https://time.geekbang.org/column/100033901)
...
> [!TIP]
> AI 应用开发 ≠ 从零炼模型：把大模型当基础设施，关键是判断“哪些规则交给模型判定”，并补齐提示词与工程化能力。
