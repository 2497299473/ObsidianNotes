---
title: 02｜技术视角：你应该知道的LLM基础知识
date: 2026-09-23
source: https://time.geekbang.org/column/article/821486
tags:
  - clippings
  - LLM
  - Token
...
> [!ABSTRACT] 快速概览
> 从技术视角拆解大模型：核心工作是“一次添加一个 Token”。覆盖 Token 与上下文窗口、按 Token 计费、温度（Temperature）与随机性，以及字符串经 One-Hot 编码再压缩为 Embedding 向量的内部表示过程。

---

## 📝 正文内容

<audio title="02｜技术视角：你应该知道的LLM基础知识" src="https://res001.geekbang.org/media/tts_audio/20250928/tts-3242-4-821052/ld/ld.m3u8"></audio>
...
- [ ] 查清当前所用模型的上下文窗口与 Token 计费规则
- [ ] 用同一提示词对比 temperature=0 与 temperature=1 的输出差异
- [ ] 阅读文末 Inside GPT 两篇，补全生成机制心智模型
...
- 极客时间《程序员的 AI 开发第一课》第 02 讲 — 郑晔
- [Inside GPT — I](https://towardsdatascience.com/inside-gpt-i-1e8840ca8093)
- [Inside GPT — II](https://towardsdatascience.com/inside-gpt-ii-why-exactly-does-your-prompt-matter-1aea1aef35da)
- [Google ML Crash Course: Embeddings](https://developers.google.com/machine-learning/crash-course/embeddings?hl=zh-cn)
...
> [!TIP]
> 大模型的工作就是一次添加一个 Token；上下文窗口决定吞吐，温度决定活跃程度，Embedding 是文本进入模型前的向量形态。
