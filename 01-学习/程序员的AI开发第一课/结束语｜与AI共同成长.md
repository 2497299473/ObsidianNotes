...
title: 结束语｜与AI共同成长
date: 2026-09-23
source: https://time.geekbang.org/column/article/834138
tags:
  - clippings
  - 费曼学习法
  - 知识体系
...
> [!ABSTRACT] 快速概览
> 以费曼学习法（以教促学、输出倒逼输入）复盘专栏写作过程，并勾勒可延展的 AI 应用开发知识体系——多模态与 Agent 两个延展方向，鼓励持续更新知识树、与 AI 共同成长。

---

## 📝 正文内容

<audio title="结束语｜与AI共同成长" src="https://res001.geekbang.org/media/tts_audio/20250929/tts-3266-4-830434/ld/ld.m3u8"></audio>
...
最后，希望你花几分钟来填写一下 结课问卷 ，我会参考同学的意见持续维护这个专栏。

## ✅ 待办事项

- [ ] 用费曼学习法重讲一遍本专栏一条主线，找出讲不清的缺口
- [ ] 画出自己的 AI 应用开发知识骨架，标出多模态 / Agent 延展点
- [ ] 上手体验 Cline 或 crewAI，对照专栏中的 Agent 核心流程
- [ ] 填写结课问卷，记录最想继续深入的两个方向

## 🔗 关联笔记

- [[21｜如何面对不断更新的大模型]] | 正文最后一讲（21）
- [[如何利用 AI 开发工具辅助开发？]] | 前沿速递加餐
- [[超越技术：AI应用的问题，不一定是技术问题]] | 视频加餐

## 📎 参考资料

- 极客时间《程序员的 AI 开发第一课》结束语 — 郑晔
...
> [!TIP]
> 以教促学：用输出倒逼输入，先搭知识骨架，再让多模态、Agent 等新知长上去。
