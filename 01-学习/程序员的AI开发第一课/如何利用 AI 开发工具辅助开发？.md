---
title: 如何利用 AI 开发工具辅助开发？
date: 2026-09-23
source: https://time.geekbang.org/column/article/875351
tags:
  - clippings
  - AI开发工具
  - Cursor
...
> [!ABSTRACT] 快速概览
> 梳理 AI 开发工具从 GitHub Copilot 到 Cursor 类 IDE 的演进，提出把 AI 当“需要指导的实习生”：任务分解、规则文件、代码评审与测试、模型选择、提供具体提示词；并强调重构、新库、代码结构发现仍须人主导，AI 只放大原有内功。

---

## 📝 正文内容

<audio title="如何利用 AI 开发工具辅助开发？" src="https://res001.geekbang.org/media/tts_audio/20250929/tts-3267-4-913923/ld/ld.m3u8"></audio>

你好，我是极客时间编辑小新。距离课程发布结束语已经过了五个月的时间，这段时间 AIGC 仍在迅猛发展。如何利用 AI 开发工具辅助开发，成为程序员圈子聊得比较多的话题。为此，我们邀请了郑晔老师把他的想法也更新到专栏里，希望能给你带来一些启发。
...
程序员早期的使用基本集中在向各种大模型提问，帮忙解决开发中遇到的各种问题。从 Github Copilot 开始，新一代的 AI 开发工具开始真正进入到程序员的日常工作中。Github Copilot 的能力集中在自动代码补全以及让 AI 根据提示词辅助生成一些代码片段上。即便如此，这也大幅度地提升了程序员的开发体验，至少一些简单问题无需再做额外的搜索。Github Copilot 的出现引发了很多追随者的出现，比如，智谱的 CodeGeeX、阿里的通义灵码。不过，这些工具基本上还是集中在开发者圈子里。

真正带来更大有影响力的开发工具是 Cursor。Cursor 第一个显著的不同是，它是一个独立的 IDE，之前的很多 AI 开发工具都以 IDE 插件形式存在的。Cursor 最大的优势在于，它可以根据用户的需求编写大规模的代码。

在一些需求明确的情形下，它甚至可以完成整个项目，这种展示是激动人心的。也是因为有这样的能力，Cursor 的出圈了。在一个宣传视频中，一个 8 岁小女孩用了 45 分钟时间构建了一个聊天机器人。这让很多不懂开发的人看到自己编写代码创建应用的可能性。Cursor 的成功同样也带来了一批追随者，比如，Windsurf、Trae、Cline 等。

除此之外，还有一些其它的方案也有人在尝试，比如，基于命令行的 Aider，用于生成 UI 的 v0，总之，这是一个快速发展的领域，各种新鲜工具层出不穷。
...
与大模型沟通，其关键点就是给大模型更多的上下文。同样，想把 AI 开发工具的能力发挥到最大，我们最好也能提供充足的上下文，越具体越好，比如一个具体的函数，如果能够给它函数签名，就比一段话的描述得到的效果要好。很多 AI 开发工具都有提供更多上下文的能力，比如，我们可以在对话中引用文件、引用目录，甚至引用具体的函数，这样，我们就可以把 AI 的注意力限制在恰当的部分。
...
- [ ] 把团队反复强调的编码要求整理成规则文件，提交进代码仓库
- [ ] 选一个 Cursor 类工具，按“一次一个小任务”完成一次半自动开发
- [ ] 为 AI 改写的老代码补齐单元测试，走一遍人工评审
- [ ] 对比至少两个编程模型在同一任务上的表现，选定自己的默认模型

## 🔗 关联笔记

- [[结束语｜与AI共同成长]] | 结束语
- [[超越技术：AI应用的问题，不一定是技术问题]] | 同属加餐
- [[12｜Agent：从聊天到工作]] | Agent 基础

## 📎 参考资料

- 极客时间《程序员的 AI 开发第一课》前沿速递 — 郑晔
- 课程导语由极客时间编辑小新撰写
...
> [!TIP]
> 把 AI 当需要指导的实习生——一次一个小任务，用规则、评审和测试兜住质量，改不对就自己上。
